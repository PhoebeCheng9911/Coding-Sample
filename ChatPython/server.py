...
class Server:
    ...
    def on_new_client(self, clientsocket, addr):
        ...
        username_map = self.socketid_username_map.pop(addr)
        self.username_userinfo_map[username_map["username"]]["is_logged_in"] = False
        self.username_userinfo_map[username_map["username"]]["addr"] = None
